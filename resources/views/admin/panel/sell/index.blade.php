                ...
                @foreach($checkout as $checkout_element)     
                    <div class="registers-item">
                        <div class="desktop-two-columns">
                            <div class="column">
                                <div class="register">
                                    <div><label for="">Id:<span>{{$sell_element->id}}</span></label></div>
                                    <div><label for="">Name:<span>{{$sell_element->name}}</span></label></div>
                            ...
                            <div class="column">
                                <div class="register-icons">
                                    <span>
                                        <svg viewBox="0 0 24 24" class="edit-button" data-url="{{route('sells_edit',['product_category'=>$sell_element->id])}}">
                                            <path fill="currentColor" d="M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z" />
                                        </svg>
                                    </span>
                                    <span>
                                        <svg viewBox="0 0 24 24" class="delete-button" data-url="{{route('sells_destroy',['product_category'=>$sell_element->id])}}">
                ...
                <div class="desktop-one-column">
                    <div class="form-group">
                        ...
                        <div class="form-input">
                            <input type="text" name="name" value="{{isset($sells->id) ? $sells->id : ''}}">
                        </div>
                    </div>
                </div>
